...
<h1 className="text-3xl sm:text-2xl md:text-4xl font-extrabold text-pink-900 mb-4 relative inline-block">
  Contact Us
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 max-w-full md:max-w-5xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg border-2 border-pink-900">
          ...
          <p className="text-pink-900 font-semibold mt-3 text-lg">+92 332 6049365</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg border-2 border-pink-900">
          ...
          <p className="text-pink-800 text-base">We’ll get back to you within 24 hours to help with your query.</p>
          <p className="text-pink-900 font-semibold mt-3 text-lg">nabaaljannah@gmail.com</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg border-2 border-pink-900">
          ...
          <p className="text-pink-800 text-base">Be part of our WhatsApp community and stay updated with all course news, schedules, and exclusive insights.</p>
        </div>
      </div>
      ...
      <div className="max-w-full md:max-w-1xl mx-auto mt-16 px-2 sm:px-0">
        ...
        <p className="text-base sm:text-lg md:text-lg text-gray-700 mb-4 text-justify">
          ...
          designed to enhance your Qur'an learning experience. Connect with <span className="text-pink-700 font-medium">like-minded learners</span>, 
          share your progress, ask questions, and receive helpful tips from experienced Asatizah. This community is not just about updates, it’s a 
        ...
        <div className="flex justify-center mt-6">
          <a
            href="https://chat.whatsapp.com/BHV9JlNCti8DolzgtMXGcp"
      ...
      {/* JOIN AS TEACHER */}
      <div className="max-w-full md:max-w-1xl mx-auto mt-16 px-2 sm:px-0">
        <h2 className="text-2xl sm:text-3xl md:text-3xl text-pink-900 mb-4 font-extrabold">Join Us as a Usatzah</h2>
        <p className="text-base sm:text-lg md:text-lg text-gray-700 mb-1 text-justify">
          If you're a passionate and qualified <span className="text-pink-700 font-medium">female Qur'an Usatzah</span>, 
          ...
          where you can share your knowledge, inspire students, and help them build a deep and meaningful connection with the Qur'an. 
          ...
          where Asatizah can grow professionally while making a <span className="text-pink-700 font-medium">positive difference in students’ lives</span>. 
      ...
      <div className="max-w-full md:max-w-1xl mx-auto mt-16 px-2 sm:px-0">
        ...
        <p className="text-base sm:text-lg md:text-lg text-gray-700 mb-4 text-justify">
          ...
          for everyone. This includes adhering to class rules, maintaining respectful communication with Asatizah and fellow students, 
