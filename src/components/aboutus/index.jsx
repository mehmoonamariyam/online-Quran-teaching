  ...
  <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
    ...
    <div className="md:w-1/2 text-center md:text-left">
      ...
      <p className="text-gray-700 leading-relaxed text-lg">
        Whether you’re a beginner or seeking to perfect your recitation, we
        provide flexible classes that fit your schedule and spiritual goals.
      </p>

      <button className="mt-8 bg-pink-900 text-white py-3 px-8 rounded-full shadow-lg hover:bg-[#C48E84] transition duration-300">
        Learn More
      </button>
    </div>
  </div>
