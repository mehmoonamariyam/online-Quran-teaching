...
import { BookOpen, Star, Users, Laptop, Heart, GraduationCap } from "lucide-react"; 
...
const coursesOverview = [
  ...
  },
  {
    ...
    description:
      "Master Tajweed and recitation under the guidance of qualified Asatizah for a perfect Quranic pronunciation.",
  },
 {
    title: "Personal Mentorship",
    icon: <GraduationCap className="w-10 h-10 text-pink-900" />,
    description:
      "Learn directly under the supervision of expert Asatizah who track your progress and guide you personally.",
  },
 {
    title: "Spiritual Enrichment",
    icon: <Heart className="w-10 h-10 text-pink-900" />,
    description:
      "Develop a deeper bond with the Qur'an, fostering inner peace and understanding of its divine message.",
  }
];
  ...
  return (
    <section className="relative py-20 px-6 md:px-16 bg-linear-to-b from-[#fbeeea] to-[#f8d9d2] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-4xl font-extrabold text-pink-900 mb-8 relative inline-block text-center">
  Our Learning Paths
</h2>
