...
<>
 <div
  ...
  ></div>
    <nav className="bg-transparent relative z-10 px-6 py-0 flex justify-between items-center">
  <div className="flex items-center">
    ...
    />
    <h1 className="text-2xl font-bold text-pink-900 whitespace-nowrap">Naba Al Jannah</h1>
  </div>
