export const API = [
  {
    ...
    details: [
      ...
      "Basic Tajweed rules such as Noon Sakinah, Tanween, and Madd",
      "Common recitation mistakes and how to avoid them",
      "Practical application through daily guided recitation",
    ],
    price: "Free",
  ...
  },
  {
    ...
    details: [
      ...
      "Mastery of Waqf (stopping rules) and continuation (Ibtidaa)",
      "Techniques for Tarteel and rhythmic beautification of recitation",
      "Recitation refinement through one-on-one correction sessions",
    ],
    price: "PKR 1500",
  ...
  },
  {
    ...
    details: [
      ...
      "Maintaining balance, clarity, and beauty while reciting",
      "Techniques for voice control, rhythm, and emotional expression",
      "Application of Tajweed rules in smooth, fluent recitation",
    ],
    price: "PKR 1000",
  ...
  },
  {
    ...
    details: [
      ...
      "Correct pronunciation through games",
      "Simple Tajweed rules",
      "Short Surah practice",
  ...
  },
  {
    ...
    details: [
      ...
      "Lessons from Qur’anic stories",
      "Modern reflections on verses",
  ...
  },
  {
    ...
    details: [
      ...
      "Memorization of selected Ayahs",
      "Personal mentorship",
    ],
    price: "PKR 3000",
